...
const GAMES = [
  {
    ...
    desc: "Two anime, one metric, 4 seconds. Pick which is higher-scored, more popular, longer — or let AI judge the most iconic. 10 rounds. Leaderboard.",
    color: "#8B5CF6",
  ...
  },
  {
    ...
    desc: "Our AI writes a cryptic vibe description for an anime — no title, no spoilers. Predict the verdict. Scored by accuracy.",
    color: "#16A34A",
